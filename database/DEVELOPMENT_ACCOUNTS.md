...
After importing `schema.sql`, import `seeds/development_accounts.sql`. The seed
is safe to run again and restores these development passwords and active roles.
